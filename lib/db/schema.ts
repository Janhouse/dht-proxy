...
// Better Auth identifies a provider account by (providerId, accountId) — its
// exported `AccountKey` type. 1.7.0 briefly keyed on (issuer, accountId)
// instead; 1.7.3 reverted that, and migration 0006 drops the column again.
